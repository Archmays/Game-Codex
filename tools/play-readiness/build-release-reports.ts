...
writeJson("FINAL_RESULT.json", { result: "PASS_MACHINE / PORTFOLIO_PLAY_READY / STABLE_FOR_NATURAL_FAMILY_USE", taskId: TASK_ID, commit, portfolioRecords: GAME_PORTFOLIO.length, classicStandalone: GAME_PORTFOLIO.filter((record) => record.currentStandaloneVisible).length, playSurfaces: PLAY_SURFACE_MANIFEST.length, knownSaveKeys: KNOWN_SAVE_KEYS.length, realChildValidation: "NOT_PERFORMED_AND_NOT_CLAIMED", naturalUseObservation: PROJECT_LIFECYCLE_TERMINAL_TRUTH.naturalUseObservation });
