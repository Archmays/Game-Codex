...
| `game-core-local-storage` | `packages/game-core` | `hanzi-radical-battle`<br>`equation-slider`<br>`math-lab`<br>`english-spell-battle`<br>`make-target`<br>`memory-card`<br>`pinyin-magic-battle` |
