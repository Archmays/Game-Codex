...
export const GAME_PORTFOLIO: readonly GamePortfolioRecord[] = [
  {
    ...
    canonicalRoute: "?play=hanzi-word-adventure", worldModuleIds: [], compatibilitySurfaceIds: [], sharedEngineIds: [], saveNamespaces: ["family-games/hanzi-word-adventure/v2", "family-games/hanzi-word-adventure/v1"],
  ...
  },
  {
    ...
    canonicalRoute: "?play=hanzi-tower-defense", worldModuleIds: [], compatibilitySurfaceIds: [], sharedEngineIds: [], saveNamespaces: ["family-games/hanzi-tower-defense/v3", "family-games/hanzi-tower-defense/v2", "family-games/hanzi-tower-defense/v1"],
