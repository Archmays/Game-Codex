...
requireValue(JSON.stringify([...classicIds].sort()) === JSON.stringify(["hanzi-tower-defense", "hanzi-word-adventure", "math-lab", "oddity-puzzles", "world-in-a-box"]), "classicGameCatalog must contain the five active products, including Oddity and World Box");
