...
export const PLAY_SURFACE_MANIFEST: readonly PlaySurfaceRecord[] = [
  ...
  surface({ id: "world-in-a-box", title: "世界盒子 · 窗边有风", route: "?play=world-in-a-box", productId: "world-in-a-box", kind: "product-world", parentSurfaceId: "my-game-world", returnRoute: "?world=my-game-world", primaryActionSelector: "[data-piece]:not([hidden])", settingsAvailable: true, destructiveActionAvailable: true, saveNamespaces: ["family-games/world-in-a-box/v1", "family-games/world-in-a-box/dresden-river-campus-v2", "family-games/world-in-a-box/audio-v1"], expectedInputs: ALL_INPUTS, qualityProfile: "b-independent-puzzle", mountDefinitionId: "world-in-a-box", runtimeOwnerDefinitionId: "world-in-a-box", topLevelProductId: "world-in-a-box", primaryEntry: true }),
