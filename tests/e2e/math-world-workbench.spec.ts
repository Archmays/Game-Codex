...
test("@workbench all 38 exact keys survive the public Vault roundtrip and the mounted old page cannot overwrite restored records", async ({ page, context }, info) => {
  ...
  await expect(vaultPage.locator("[data-vault-status]")).toContainText("已恢复 37");
