...
if (COMPATIBILITY_SURFACES.length !== 2 || SHARED_ENGINES.length !== 2 || KNOWN_SAVE_KEYS.length !== 49) issues.push("current compatibility/save inventory after authorized World Box addition");
