...
export const COMPLETE_NEW_CHARACTER_SEEDS = [
  ...
  { glyph: "歌", pinyin: "gē", familiarWord: "唱歌", shortMeaning: "可以唱出来的曲调和词", chapterId: "chapter-three", band: "story-required", worldTag: "myriad-book-harbor", structure: "left-right", components: [{ glyph: "哥", role: "phonetic" }, { glyph: "欠", role: "semantic" }], illustrationBrief: "可见音符波纹从伙伴身边飘出，静音仍完整。", magicName: "歌声帆风", magicEffect: "歌声波纹鼓起书页船帆，静音时仍清楚可见。", familiarity: "high", ambiguityRisk: "声音不是规则前提；哥与欠只按结构位置呈现。" },
  { glyph: "响", pinyin: "xiǎng", familiarWord: "声响", shortMeaning: "耳朵能听见的声音", chapterId: "chapter-three", band: "story-required", worldTag: "myriad-book-harbor", structure: "left-right", components: [{ glyph: "口", role: "semantic" }, { glyph: "向", role: "phonetic" }], illustrationBrief: "柔和声波碰到书港灯塔后返回，不闪烁。", magicName: "声响回港", magicEffect: "一圈可见回声找到迷雾里的书页船。", familiarity: "high", ambiguityRisk: "响也可表示发出声音；固定在声响词语且提供视觉等价信息。" },
  ...
  { glyph: "景", pinyin: "jǐng", familiarWord: "风景", shortMeaning: "看到的自然或城市景象", chapterId: "chapter-three", band: "optional", worldTag: "word-heart-core", structure: "top-bottom", components: [{ glyph: "日", role: "semantic" }, { glyph: "京", role: "phonetic" }], illustrationBrief: "晨光照亮远山、河流和灯街的整体景象。", magicName: "风景展开", magicEffect: "一幅无字光景展开，串起已经修复的森林。", familiarity: "near", ambiguityRisk: "画面表达熟悉风景，不把日与京编成字源故事。" },
  { glyph: "晨", pinyin: "chén", familiarWord: "清晨", shortMeaning: "太阳刚升起的早上", chapterId: "chapter-three", band: "optional", worldTag: "word-heart-core", structure: "top-bottom", components: [{ glyph: "日", role: "semantic" }, { glyph: "辰", role: "phonetic" }], illustrationBrief: "清晨柔光从山后升起，不出现时钟倒计时。", magicName: "晨光归林", magicEffect: "第一束晨光穿过书港，照到森林每条路。", familiarity: "high", ambiguityRisk: "辰需清楚大字；晨光只表现时间语境，不设置每日奖励。" },
