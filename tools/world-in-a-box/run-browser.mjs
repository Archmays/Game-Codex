...
try{
 ...
 const source=(await readFile(script,'utf8')).replaceAll('docs/world-in-a-box/evidence/',process.env.QA_EVIDENCE_ROOT||'docs/world-in-a-box/evidence/').replaceAll('tmp/tasks/world-box-r2/','tmp/tasks/world-box-step02/legacy/');
