...
requireValue(JSON.stringify([...classicIds].sort()) === JSON.stringify(["hanzi-tower-defense", "hanzi-word-adventure", "math-lab", "world-in-a-box"]), "classicGameCatalog must contain the four active products, including World Box");
