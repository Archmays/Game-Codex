...
if (COMPATIBILITY_SURFACES.length !== 2 || SHARED_ENGINES.length !== 2 || KNOWN_SAVE_KEYS.length !== 45) issues.push("current compatibility/save inventory after authorized STEP5 independent save additions");
