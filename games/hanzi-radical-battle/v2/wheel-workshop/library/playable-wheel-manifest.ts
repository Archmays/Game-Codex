...
const PLAYABLE_BLUEPRINTS: readonly PlayableBlueprint[] = [
  { legacyId: "p1.char.000", shortMeaning: "光亮，也可以表示清楚、懂得。", familiarWord: "光明" },
  { legacyId: "p1.char.001", shortMeaning: "顶端细小而锐利。" },
  { legacyId: "p1.char.002", shortMeaning: "使火光停止，或让事物不再存在。" },
  { legacyId: "p1.char.017", shortMeaning: "记录语言的书写符号，也就是我们读写的字。" },
  { legacyId: "p2.char.000", shortMeaning: "干净、清澈。" },
  { legacyId: "p2.char.001", shortMeaning: "天空没有雨云。" },
  { legacyId: "p2.char.009", shortMeaning: "用手臂围住，也可表示把东西抱在怀里。" },
  { legacyId: "p2.char.011", shortMeaning: "一种四季常青的树。" },
  { legacyId: "p3.char.007", shortMeaning: "一类茎通常较柔软的植物，也可指草地。" },
  ...
  { legacyId: "p4.char.000", shortMeaning: "水汽较多、湿润；也指海水按时涨落。" },
  ...
  { legacyId: "p6.char.013", shortMeaning: "用来盛放东西、口部较宽的器具。" },
  { legacyId: "p6.char.009", shortMeaning: "天气寒冷时凝结的白色冰晶。", familiarWord: "冰霜" },
  { legacyId: "j1.char.000", shortMeaning: "事物在形成或准备之中。" },
  { legacyId: "j1.char.010", shortMeaning: "枫树，叶子在秋天常会变成红色或黄色。" },
  ...
  { legacyId: "j2.char.004", shortMeaning: "在“酷似”中表示非常、极其相似。" },
  { legacyId: "j2.char.006", shortMeaning: "文雅、熟练。" },
  { legacyId: "j3.char.013", shortMeaning: "阅读、查看文字或资料。" },
  { legacyId: "j3.char.003", shortMeaning: "在“可汗”中读 hán，是古代民族首领的称号用字。", spokenPhrase: "可汗" },
  { legacyId: "j3.char.004", shortMeaning: "有彩色花纹的丝织物，也表示华美。" },
  { legacyId: "j3.char.010", shortMeaning: "从中心到边缘距离相等的形状。", familiarWord: "圆形" },
] as const;

export const WHEEL_GRADE_OPTIONS = [
  { id: "journey", label: "跟随当前旅程", worldName: "旅程回声卷" },
  { id: "p1", label: "一年级", worldName: "晨光启程卷" },
  { id: "p2", label: "二年级", worldName: "溪光伙伴卷" },
  { id: "p3", label: "三年级", worldName: "芽园发现卷" },
  { id: "p4", label: "四年级", worldName: "远岸行旅卷" },
  { id: "p5", label: "五年级", worldName: "星灯探寻卷" },
  { id: "p6", label: "六年级", worldName: "冬光守望卷" },
  { id: "j1", label: "初一", worldName: "林间回声卷" },
  { id: "j2", label: "初二", worldName: "深墨辨形卷" },
  { id: "j3", label: "初三", worldName: "绮光远眺卷" },
...
function makePlayable(blueprint: PlayableBlueprint): PlayableWheelRecord {
  ...
  const familiarWord = blueprint.familiarWord ?? record.words[0];
  if (!record.words.includes(familiarWord)) throw new Error(`Playable familiar word is not preserved in the raw record: ${blueprint.legacyId} ${familiarWord}`);
  const stable = {
    ...
    familiarWord,
    spokenPhrase: blueprint.spokenPhrase ?? `${record.result}，${familiarWord}`,
