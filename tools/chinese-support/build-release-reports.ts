...
const HISTORICAL_CLASSIC_IDS = ["hanzi-radical-battle", "equation-slider", "math-lab", "english-spell-battle", "make-target", "memory-card"] as const;
...
const common = { taskId: "GAME-CODEX-CHINESE-CONSOLIDATION-03", product: "墨迹森林外围整合 · 声韵试炼与字光配对", version: "V1.0.0", evidenceScope: "HISTORICAL_RELEASE_TAG", finalCommit: commit, generatedAtUtc: new Date().toISOString() };
...
writeJson("PORTFOLIO_BEFORE_AFTER.json", { evidenceScope: "HISTORICAL_RELEASE_TAG", before: { records: 9, classicStandalone: 7, pinyinStandaloneVisible: true, memoryStandaloneVisible: true }, after: { records: 9, classicStandalone: HISTORICAL_CLASSIC_IDS.length, pinyinStandaloneVisible: false, memoryStandaloneVisible: true, hanziShortActivities: 2 }, expectedDefinitions: 9 });
writeJson("CATALOG_SHADOW_AND_FINAL.json", { evidenceScope: "HISTORICAL_RELEASE_TAG", shadow: { classicCards: 7, observedAtBaseline: "f49c439b47229f7d02b61473e51e60c9b89991e7" }, replacementGate: { pinyinModes: "3/3 PASS", memoryWrappers: "2/2 PASS", browserProfiles: "PASS", saveCompatibility: "PASS" }, final: { classicCards: HISTORICAL_CLASSIC_IDS.length, ids: HISTORICAL_CLASSIC_IDS, pinyinDefinitionRetained: GAME_PORTFOLIO.some((record) => record.id === "pinyin-magic-battle") } });
