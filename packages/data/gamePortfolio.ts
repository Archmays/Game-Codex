...
export interface GamePortfolioRecord {
  ...
  readonly contentStatus: "frozen" | "playable";
...
export const GAME_PORTFOLIO: readonly GamePortfolioRecord[] = [
  ...
  },
  {
    ...
    canonicalRoute: "?play=world-in-a-box", worldModuleIds: [], compatibilitySurfaceIds: [], sharedEngineIds: ["game-core-local-storage"], saveNamespaces: ["family-games/world-in-a-box/v1", "family-games/world-in-a-box/dresden-river-campus-v2", "family-games/world-in-a-box/audio-v1", "family-games/world-in-a-box/chancellor-desk-v1", "family-games/world-in-a-box/chancellor-voice-v1"],
  ...
  },
  {
    ...
    canonicalRoute: "?play=hanzi-tower-defense", worldModuleIds: [], compatibilitySurfaceIds: [], sharedEngineIds: [], saveNamespaces: ["family-games/hanzi-tower-defense/tactics/v1", "family-games/hanzi-tower-defense/v3", "family-games/hanzi-tower-defense/v2", "family-games/hanzi-tower-defense/v1"],
  ...
  },
  {
    ...
    mergeTarget: "math-world", canonicalRoute: "?world=math-world&from=hub", worldModuleIds: [], compatibilitySurfaceIds: [], sharedEngineIds: ["game-core-local-storage"], saveNamespaces: ["family-games/math-world/v1"],
    testProfile: "a-core-world", loadingPolicy: "route-lazy", contentStatus: "frozen", canonicalDocs: ["games/math-lab/README.md", "docs/portfolio-retirement-step1.md"],
  },
  {
...
export const SHARED_ENGINES: readonly SharedEngineRecord[] = [
  { id: "memory-match", path: "packages/activity-engines/memory-match", consumers: ["memory-card"] },
  { id: "game-core-local-storage", path: "packages/game-core", consumers: GAME_PORTFOLIO.filter(record => record.sharedEngineIds.includes("game-core-local-storage")).map((record) => record.id) },
] as const;
