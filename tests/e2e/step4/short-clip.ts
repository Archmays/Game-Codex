...
export async function shortClip(page:Page, directory:string, milliseconds=20000, everyNthFrame=4):Promise<()=>Promise<number>> {
  ...
  await session.send('Page.startScreencast',{format:'jpeg',quality:72,maxWidth:1280,maxHeight:960,everyNthFrame});
