...
export const KNOWN_SAVE_KEYS: readonly KnownSaveKey[] = [
  { key: "family-games/oddity-puzzles/v1", owner: "shared", purpose: "progress", exportable: true, maxVersion: 1 },
  { key: "family-games/world-in-a-box/audio-v1", owner: "shared", purpose: "settings", exportable: true, maxVersion: 1 },
  { key: "family-games/world-in-a-box/chancellor-desk-v1", owner: "shared", purpose: "progress", exportable: true, maxVersion: 1 },
  { key: "family-games/world-in-a-box/chancellor-voice-v1", owner: "shared", purpose: "settings", exportable: true },
