...
if (COMPATIBILITY_SURFACES.length !== 2 || SHARED_ENGINES.length !== 2 || KNOWN_SAVE_KEYS.length !== 51) issues.push("current compatibility/save inventory after authorized World Box and Oddity additions");
