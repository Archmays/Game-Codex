...
Portfolio 与 `allGameDefinitions` 保留 9 个可挂载定义；经典大厅当前展示 6 个独立入口。默认入口 `/` 是儿童侧“我的游戏世界”，其中可进入墨迹森林、数学世界和游戏百宝箱。

| 游戏 | 学科 | 适合年龄 | 目标世界 | 产品角色 | 质量等级 | 当前状态 |
| --- | --- | --- | --- | --- | --- | --- |
| 汉字魔法战 | 识字 | 家庭儿童 | 中文世界 | 旗舰 | S | 墨迹森林完整篇 |
| 算式滑轨 | 数学 | 6-10 岁 | 数学世界 | 旗舰 | S | 可玩 |
| 数学世界 | 数学 | 6-9 岁 | 数学世界 | 核心世界 | A | 可玩 |
| 英语世界 | 英语 | 5-9 岁 | 英语世界 | 核心世界 | A | 英语世界 V2 |
| 目标工坊 | 数学 | 7-10 岁 | 数学世界 | 独立谜题 | B | 数学世界模块 |
| 时钟塔 | 数学 | 5-7 岁 | 数学世界 | 模块 | C | 数学世界模块 |
| 阵列工坊 | 数学 | 7-9 岁 | 数学世界 | 模块 | C | 数学世界模块 |
...
项目阶段：Foundation、Math World、Chinese Consolidation、English V2 与 Play Readiness 均为 COMPLETE；Natural-use Observation 仍为 PENDING_REAL_EVIDENCE，家长主动 Observation Kit 已 READY。
<!-- GAME_PORTFOLIO:END -->
...
- `?hub=classic`：6 个当前独立入口的经典大厅；拼音独立卡已由墨迹森林“声韵试炼”替代，记忆配对继续保留；
