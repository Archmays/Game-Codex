...
const BASELINE_ROOT = resolve("tests/hanzi-v2/baselines/v1");
const PROOF_PATH = resolve("test-results/hanzi-v2/v1/V1-VISUAL-ARIA-NO-UPDATE-PROOF.json");
const GEOMETRY_PATH = resolve("test-results/hanzi-v2/v1/V1-CRITICAL-CONTROL-GEOMETRY.json");
