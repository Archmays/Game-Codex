...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 世界盒子 | `world-in-a-box` | 共享模块 | 活跃儿童产品 | 独立谜题 | B | `active` | 是 | 是 | ?play=world-in-a-box | `family-games/world-in-a-box/v1`<br>`family-games/world-in-a-box/dresden-river-campus-v2` |
