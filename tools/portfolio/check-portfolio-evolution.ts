...
if (COMPATIBILITY_SURFACES.length !== 2 || SHARED_ENGINES.length !== 2 || KNOWN_SAVE_KEYS.length !== 43) issues.push("current compatibility/save inventory after authorized STEP4 save additions");
